                ...
                <div className="row">
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info groom-info">
                            <h3>
                                Phaniband Mohammed Shoaib,
                                {/* <sub>B.Tech.,</sub> */}
                            </h3>
                            <p className="mt-2 mt-lg-3">
                                Profession: <strong>Spray Painter,</strong> at
                            </p>
                            <p className="mt-1 mt-lg-2">
                                Saudi AramCo., Tirumala Nagar,
                            </p>
                            <p className="mt-1 mt-lg-2">Adoni.</p>
                            <p className="mt-1 mt-lg-2">
                                Grand S/O Janab{" "}
                                <strong>Phaniband Abdul Salaam(Late).</strong>
                            </p>
                            {/* <p className="mt-1 mt-lg-2">
                    ...
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info bride-info">
                            ...
                            <p className="mt-2 mt-lg-3">
                                D/O Janab <strong>S. Iqbal Basha Sahab,</strong>
                            </p>
                            <p className="mt-1 mt-lg-2">
                                Grand D/O Janab{" "}
                                <strong>Abdul Raheem Sahab(Late),</strong>
                            </p>
                            <p className="mt-1 mt-lg-2">
                                H.No.: 11/222, Jamkhanwadi Street, Adoni.
                            </p>
                            {/* <p className="mt-1 mt-lg-2">
